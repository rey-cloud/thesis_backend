...
// onMounted(() => {
//   fetchUser() // Load user data when the component mounts
// });
...
//       state.user.middle_initial = data.middle_initial;
//       state.user.gender = data.gender;
//       state.user.phone_number = data.phone_number;
//       state.user.email = data.email;
//       state.user.role = data.role || user.role;
//       state.user.status = data.status || user.status;
//       state.user.username = data.username || user.username;
//     } else {
